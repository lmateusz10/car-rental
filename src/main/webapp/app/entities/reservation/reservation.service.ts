...
export class ReservationService {
    ...
    protected convertDateFromClient(reservation: IReservation): IReservation {
        const copy: IReservation = Object.assign({}, reservation, {
            ...
            endDate: reservation.endDate != null && reservation.endDate.isValid() ? reservation.endDate.format(DATE_FORMAT) : null
        });
        return copy;
    }
    ...
    protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        if (res.body) {
            res.body.forEach((reservation: IReservation) => {
                ...
                reservation.endDate = reservation.endDate != null ? moment(reservation.endDate) : null;
            });
        }
        return res;
    }
