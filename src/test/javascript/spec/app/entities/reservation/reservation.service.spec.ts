...
import { IReservation, Reservation, PaymentStatus } from 'app/shared/model/reservation.model';
...
describe('Service Tests', () => {
    describe('Reservation Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Reservation(0, currentDate, currentDate, PaymentStatus.NEW);
        });
