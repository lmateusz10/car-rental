...
import io.github.rentalcar.application.domain.enumeration.PaymentStatus;
/**
...
public class ReservationResourceIntTest {
    ...
    public void createReservation() throws Exception {
        ...
        assertThat(testReservation.getPaymentStatus()).isEqualTo(DEFAULT_PAYMENT_STATUS);
    }
    ...
    public void updateReservation() throws Exception {
        ...
        assertThat(testReservation.getPaymentStatus()).isEqualTo(UPDATED_PAYMENT_STATUS);
    }
